...
/**
 * @package Mysql Schema class
 * @author Amadi Ifeanyi <amadiify.com>
 * 
 * This is the default Schema class for Mysql database system
 */
			...
			foreach ($oldKeys as $index => $column) :
				...
				if (isset($newKeys[$index])) :
					...
					if ($newcolumn != $column) :
                        ...
                        // statement changed
						if ($newLine != $oldLine) $sqlArray[] = "ALTER TABLE `{$this->tableName}` CHANGE COLUMN {$newcolumn} {$newcolumn} $newLine;";
